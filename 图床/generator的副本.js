...
if (restful.galleries && site.data.galleries) {
    apiData = apiData.concatl(site.data.galleries.map(function (item)  {
      var path = 'api/galleries/' + item.name + '.json';
      return {
      path: path,
      data: JSON.stringify(item)
